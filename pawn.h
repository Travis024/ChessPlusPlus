...
class Pawn : public Piece
{
     ...
     Q_OBJECT
public:
    Pawn(int team); //Create a new instance of the Pawn class
    Pawn * Clone(); //Make a copy of the Pawn instance
...
private:
    ...
    int piece_number_ = 0; //an identification for the piece, used for determining the type of piece within the board class

    //Store the x and y coordinates of the Pawn
    int x_coordinate_;
    int y_coordinate_;

    //The row number and column number of the tile the Pawn is on
