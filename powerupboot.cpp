...
PowerupBoot::PowerupBoot()
{
    //Set the image path
    QString image_path;
    image_path = R"(./img/powerup_boot.png)";
...
/*
Returns a copyied insatnce of the PowerupBoot

@param: None
@return: A pointer to a copied instance of the PowerupBoot
*/
PowerupBoot * PowerupBoot::Clone(){
    return new PowerupBoot();
}
...
*/
void PowerupBoot::mousePressEvent(QGraphicsSceneMouseEvent * /*usnused*/){
